const temp = document.getElementById("temp"),
  ...
  time_zone = document.getElementById("time-zone");
...
function getWeatherData(city, unit, hourlyorWeek) {
  console.log(city);
  const apiKey = "XQ946XVD5MZC82C7NSUHELETF";
  fetch(
    ...
    .then((data) => {
      ...
      time_zone.innerText = " (" + data.timezone + ")";
      zone.innerText = data.tzoffset + "GMT";
...
function changeBackground(condition) {
  ...
  let bg = "";
  if (condition === "Partly-cloudy-day") {
    bg = "https://source.unsplash.com/1920x1080?cloudy,day";
  } else if (condition === "partly-cloudy-night") {
    bg = "https://source.unsplash.com/1920x1080?cloudy,night";
  } else if (condition === "rain") {
    bg = "https://source.unsplash.com/1920x1080?rainy";
  } else if (condition === "clear-day") {
    bg = "https://source.unsplash.com/1920x1080?day,sunshine";
  } else if (condition === "clear-night") {
    bg = "https://source.unsplash.com/1920x1080?night";
  } else {
    bg = "https://source.unsplash.com/1920x1080?cloud";
  }
